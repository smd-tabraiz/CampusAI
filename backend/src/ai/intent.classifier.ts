import { IntentClassificationResult, IntentType, ExtractedEntities } from './types';

export class IntentClassifier {
  /**
   * Classify user text into an intent with confidence score and extracted entities.
   */
  static classify(text: string): IntentClassificationResult {
    ...
    let intent: IntentType = 'GENERAL_CAMPUS_QUERY';
    let confidence = 0.85;
    ...
    if (
      cleanText.includes('where can i print') ||
